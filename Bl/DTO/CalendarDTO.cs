...
public class CalendarDTO
{
    ...
    public Dictionary<WashAbleDTO, DateTime> GetNecessaryWasAbles( int spareDays,
            List<WashAbleDTO> cleanWashAbles, List<WashAbleDTO> dirtyWashAbles)
        {
            ...
            Dictionary<DateTime, Dictionary<string, List<Category>>> calendar = new();
            calendar = GetWashAbleAcordingSoonDates(this.Calendar, spareDays);
